      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <Card
                className="relative p-8 h-full hover-elevate active-elevate-2 transition-all duration-300 bg-card/30 backdrop-blur-xl border-border/50 overflow-visible group hover:shadow-xl hover:-translate-y-1"
