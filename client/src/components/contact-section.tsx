  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "hello@vertexcloud.com",
      href: "mailto:hello@vertexcloud.com",
    },
    {
      icon: Phone,
      title: "Phone",
            ...
            <Card className="p-8 bg-card/30 backdrop-blur-xl border-border/50">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full bg-gradient-to-r from-gradient-from via-gradient-via to-gradient-to text-white font-medium hover:shadow-lg transition-all duration-300 gap-2"
                >
